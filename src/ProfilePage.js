...
import { db, imgStorage, auth } from './firebase-config';
...
const ProfilePage = (props) => {
    ...
    return (
        <div>
            <Header userPic={currentUser.photoURL} uid={currentUser.uid}/>
            <div id="profileBodyContainer">
                <div id="profileTopContainer">
                    <img src={currentUser.photoURL} alt="" referrerPolicy="no-referrer"></img>
                    <div id="profileTextContainer">
                        <div id="profileHeaderLine">
                            <h1 id="profileUsername">{currentUser.displayName.split(/[ ,]+/).join('_').toLowerCase()}</h1>
